...
using FileProcessBackEnd.Extensions;
...
namespace FileProcessBackEnd.Services
{
    ...
    {
        public async Task<ProccesedData> ExtractDataFromExcelFileAsync(string filname)
        {
            ...
            var numDivBy2 = string.Empty;
            var sumOddNumbers = string.Empty;
            var sumEvenNumbers = string.Empty;
            var sumSingleDigits = string.Empty;
            var sumDoubleDigits = string.Empty;
            ...
            try
            {
                ...
                sumEvenNumbers = evenNumbersList.Sum().ToString();
                sumOddNumbers = oddNumbersList.Sum().ToString();
                sumSingleDigits = allValues.Where(x => x < 10).Sum().ToString();
                sumDoubleDigits = evenNumbersList.Where(x => x > 9).Sum().ToString();
                ...
                data = new ProccesedData
                {
                    ...
                    NumbersDivBy2 = evenNumbers,
                    SumOfEvenNumbers = sumEvenNumbers,
                    SumOfDoubleDigits = sumDoubleDigits,
                    SumOfOddNumbers = sumOddNumbers,
                    SumOfSingleNumbers = sumSingleDigits,
